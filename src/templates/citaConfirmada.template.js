...
const generarTemplateCita = (data) => {
  const {
    nombre,
    fecha,
    hora,
  ...
  <mjml>
    <mj-head>
      <mj-preview>Confirmación de tu cita 💈</mj-preview>
      ...
      <mj-section padding="20px">
        <mj-column background-color="#ffffff" border-radius="12px" padding="25px">
          ...
          <mj-text color="#555555">
            Tu cita ha sido <strong>confirmada</strong>. Aquí tienes los detalles:
          </mj-text>
...
module.exports = generarTemplateCita;